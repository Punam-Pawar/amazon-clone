...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #1d2733; color: white; padding: 5px; margin-top:0px">
		<h2>Amazon.in</h2>
			...
			<div class="navbar-header">
				...
				<span
					class="glyphicon glyphicon-home">&nbsp;</span>
									...
									<a href="index.jsp"> 
									<img src="./image/amazonlogonew.png" style="width:100px; height:60px; margin-left:30px;" >
					</a>
